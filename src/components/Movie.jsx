      ...
      {movieObj.is_active && (
        <div className="card movie position-relative">
          ...
          <div className="card-body">
            ...
            <button className="btn btn-link fs-5 position-absolute top-0 start-0 text-danger" onClick={()=>(onAddToWatchList(movieObj))} ><i className="bi bi-plus-circle"></i></button>
          </div>
        </div>
      )}
    </div>
